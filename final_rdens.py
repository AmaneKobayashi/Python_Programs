     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': u'HIO-SW_final_rdens.MRC',
       'path': u'HIO-SW_final_rdens.MRC',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'representation': 'mesh',
        'session_volume_id': 'sJnsanj\x0c1Dh$YcA"vT$pA,}NMjj%A<S`',
        ...
        'solid_levels': [
          ( -0.030560515022277829, 0, ),
          ( 0.06248609018325807, 0.99, ),
          ( 3.736222743988037, 1, ),
         ],
        'solid_model': None,
       ...
       },
       {
        ...
        'session_volume_id': 'ybV&T1Rg*/YP3v=:Mr}-[1SJ$!|/I[]j',
        'solid_brightness_factor': 1.0,
        'solid_colors': [
          ( 1, 1, 0.7, 1, ),
          ( 1, 1, 0.7, 1, ),
       ...
       },
       {
        ...
        'representation': 'mesh',
        'session_volume_id': 'w\tcW+w$wQ0\taLTH/<$C\x0bke,r[4u>oxXQ',
        'solid_brightness_factor': 1.0,
        'solid_colors': [
          ( 0.7, 1, 1, 1, ),
          ( 0.7, 1, 1, 1, ),
       ...
       },
       {
        ...
        'representation': 'surface',
        'session_volume_id': 'y~2:3H5b\'i\t`K\'l]hOEvJ"e/M/x+\x0cx\t-',
        'solid_brightness_factor': 1.0,
        'solid_colors': [
          ( 0.7, 0.7, 1, 1, ),
          ( 0.7, 0.7, 1, 1, ),
 ...
 volume_dialog_state = \
  {
   ...
   'data_cache_size': '512',
   'focus_volume': 'y~2:3H5b\'i\t`K\'l]hOEvJ"e/M/x+\x0cx\t-',
   'geometry': u'392x634+1100+262',
   'histogram_active_order': [ 0, 1, 2, ],
   'histogram_volumes': [ 'y~2:3H5b\'i\t`K\'l]hOEvJ"e/M/x+\x0cx\t-', 'ybV&T1Rg*/YP3v=:Mr}-[1SJ$!|/I[]j', 'w\tcW+w$wQ0\taLTH/<$C\x0bke,r[4u>oxXQ', ],
   'immediate_update': 1,
   'initial_colors': (
     ( 0.7, 0.7, 0.7, 1, ),
     ( 1, 1, 0.7, 1, ),
   ...
   'show_on_open': 1,
   'show_plane': 1,
   'shown_panels': [ 'Threshold and Color', 'Display style', 'Surface and Mesh options', ],
 ...
 scale_bar_state = \
  {
   ...
   'model': {
     ...
     'xform': {
       ...
       'rotation_angle': 0.0,
       'rotation_axis': ( 0.0, 0.0, 1.0, ),
       'translation': ( 61.88521074813953, 33.49393901705362, 66.57095527648926, ),
       'version': 1,
      },
    },
   'move_scalebar': False,
   ...
   'preserve_position': 1,
   'screen_x_position': '-0.026',
   'screen_y_position': '-0.82',
   'show_scalebar': True,
   'version': 1,
  }
